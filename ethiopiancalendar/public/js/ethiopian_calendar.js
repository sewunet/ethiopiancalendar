/* http://keith-wood.name/calendars.html
   ...
   (function($) { // Hide scope, no $ conflict
	...
	Date.prototype.toJulianDate = function() {
		var julianDate = Math.floor((this.getTime() / 86400000) + 2440587.5);
		return julianDate;
	}
	$.extend(EthiopianCalendar.prototype, {
        ...
        /** Retrieve today's date in the Ethiopian calendar.
            @memberof EthiopianCalendar
            @return {CDate} The current Ethiopian date. */
			today: function() {
				var todayJD = new Date().toJulianDate(); // Function to get today's Julian date
				return this.fromJD(todayJD);
			}
		
	
		// Add function to get today's Julian date
  ...
  maxDate: $.calendars.newDate(2010, 12, 31)}) */
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				...
				nextText: 'ቀጣይ&gt;',
				nextStatus: 'የሚቀጥለውን ወር አሳይ',
				nextJumpText: '&gt;&gt;',
				nextJumpStatus: 'የሚቀጥለውን ዓመት አሳይ',
				currentText: 'የአሁኑ',
				currentStatus: 'የአሁኑን ወር አሳይ',
				todayText: 'ዛሬ',
				todayStatus: 'የዛሬውን ወር አሳይ',
				clearText: 'አጽዳ',
				clearStatus: 'ሁሉንም ቀኖች አጽዳ',
				closeText: 'ዝጋ',
				closeStatus: 'የቀን መራጩን ዝጋ',
				yearStatus: 'ዓመቱን ይቀይሩ',
				earlierText: '&#160;&#160;▲',
				laterText: '&#160;&#160;▼',
				monthStatus: 'ወር ቀይር',
				weekText: 'Wk',
				weekStatus: 'የዓመቱ ሳምንት',
				dayStatus: 'DD፣ M d፣ yyyy ይምረጡ',
				defaultStatus: 'ቀን ይምረጡ',
				isRTL: false
			}
		},
